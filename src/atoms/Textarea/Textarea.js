...
function Textarea(props) {
    ...
    const typingInfoClassName = [
        'Textarea--typingInfo',
        charNumber >= maxlength && 'is-max',
    ]
        .join(' ')
        .replace(/\s{2,}/g, ' ');
        ...
        return (
            <div className={typingInfoClassName}>
                <Text size="xs" align="right">
                    <span className="Textarea--typingInfo--active">
                        {charNumber}
                    </span>
                    <span className="Textarea--typingInfo--total">
                        /{maxlength}
                    </span>
                </Text>
            </div>
    ...
    return (
        <div className="Textarea--container">
            <div className={mod_class}>
                ...
                {contentInside ? (
                    <div className="Textarea--contentInside">
                        {contentInside}
                    </div>
                ) : (
                    <></>
