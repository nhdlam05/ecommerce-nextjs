...
const CalendarProviderOverrides = () => {
    ...
    const [deleteOverrideEvents] = useMutation(
        DELETE_OVERRIDE_EVENTS,
        refetchOption
    );
        ...
        <div className="CalendarProviderOverrides">
            <div className="CalendarProviderOverrides--header">
                <Section spacingBottom="s">
                    <Title size="m">
                        {translate('calendar.provider.overrides.title')}
                    </Title>
                    <Text size="s">
                        {translate('calendar.provider.overrides.subtitle')}
                    </Text>
                </Section>
                ...
                <Section spacingBottom="s">
                    <Button
                        label={translate(
                            'calendar.provider.overrides.mainAction'
                        )}
            ...
            {activeOverrides && (
                <Section spacingBottom="s">
                    {loading && <Loader />}
                    {!loading &&
                        activeOverrides.activeOverrideEvents.map((d) =>
                            renderActiveOverrideEvents(d)
                        )}
                </Section>
            )}
        </div>
